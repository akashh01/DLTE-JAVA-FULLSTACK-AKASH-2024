...
public class EmployeeDetails implements CollectCheckData {
   ...
   // static HashMap<Integer,Object> hashPermenantAdd=new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        employeeToDb employeeToDbTwo=new employeeToDb();
        //;
        //
        //int choice;
        while(true){
...
//                     arrayEmployee=readWriteEmployee.readFromFile();
                   ...
                   //   employeeToDb employeeToDb=new employeeToDb();
                    //   System.out.println(employee1);
                       employeeToDbTwo.writeEmployeeToDatabase(employee1.getFirstName(),employee1.getMiddeName(),employee1.getLastName(),employee1.getEmployeePhone(),employee1.getEmployeeId(),employee1.getEmail());
                       Address permenantAddress=employeeDetails.collectAddress();
                       employeeToDbTwo.addressToDb(permenantAddress.getHouseName(),permenantAddress.getStreetName(),permenantAddress.getCityName(),permenantAddress.getStateName(),permenantAddress.getPincode(),employee1.getEmployeeId());
                       Address temporaryAddress=employeeDetails.collectAddress();
                       employeeToDbTwo.tempAddressToDb(temporaryAddress.getHouseName(),temporaryAddress.getStreetName(),temporaryAddress.getCityName(),temporaryAddress.getStateName(),temporaryAddress.getPincode(),employee1.getEmployeeId());
                     break;
    ...
    @Override
    public Employee collectPersonalData(Employee employee1) {
        try {
            EmployeeDetails employeeDetails = new EmployeeDetails();
            //name
